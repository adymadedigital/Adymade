...
INSERT INTO public.blogs (title, slug, category, excerpt, image_url, alt_text, seo_title, seo_description, seo_keywords, read_time, featured, author_name, content)
VALUES
(
  ...
  'How to Cut Lead Response Time using AI Automation | Adymade',
  'Read our detailed guide on how we cut a B2B client''s lead response times from 8 hours to under 30 minutes with WhatsApp intake & CRM routing automation.',
  'lead response time, ai automation, lead routing, n8n, make, CRM integration, sales automation',
  '7 min read',
  true,
  'Adymade Team',
  '[
...
(
  ...
  'AI Video Production vs Traditional Video Marketing Costs | Adymade',
  'Learn how AI video production drops marketing costs by 80% and where professional human editors still matter.',
  'ai video, video marketing, traditional video production, cost savings, synthetic media',
  '5 min read',
  false,
  'Adymade Team',
  '[
...
(
  ...
  'Is Your Corporate Website Costing You Enterprise Clients? | Adymade',
  'Discover the 7 critical website design errors that signals vendor risk to enterprise procurement teams.',
  'web development, enterprise website audit, web design risk, speed optimization, B2B landing pages',
  '6 min read',
  false,
  'Adymade Team',
  '[
...
(
  ...
  'GEO 101: Optimizing Content for ChatGPT & AI Search Overviews',
  'Explore Generative Engine Optimization (GEO) tactics to secure brand citations in ChatGPT, Perplexity, and Google AI Overviews.',
  'GEO, generative engine optimization, SEO, ChatGPT citation, Google AI Overviews, search optimization',
  '8 min read',
  false,
  'Adymade Team',
  '[
...
(
  ...
  'Build vs Buy: Custom Software vs SaaS Decisions for Founders',
  'A founder''s checklist to determine whether to build bespoke custom software or buy off-the-shelf SaaS solutions.',
  'custom software development, build vs buy, founder framework, SaaS selection, software ROI',
  '4 min read',
  false,
  'Adymade Team',
  '[
...
(
  ...
  'Compliance Video Marketing Guide for Regulated Industries',
  'How healthcare, pharma, and financial brands create engaging video content within compliance guardrails.',
  'video compliance, marketing regulatory, pharma videos, financial brand video marketing, health video compliance',
  '5 min read',
  false,
  'Adymade Team',
  '[
...
(
  ...
  '5 High-ROI AI Agents to Deploy in 2026 for Mid-Size Businesses',
  'A list of the 5 most effective, high-ROI AI agents mid-size companies should deploy in 2026 to automate admin operations.',
  'AI agents 2026, automation, inbox triage, invoice reconciliation, robotic process automation',
  '6 min read',
  false,
  'Adymade Team',
  '[
